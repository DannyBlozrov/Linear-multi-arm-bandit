...
The code contains simulations and an algorithm to solve the multi armed bandit problem , and is based around our paper which can be found at  [Typst](https://typst.app/project/rID3L_KmAjmQz75AsGRRrk). 
